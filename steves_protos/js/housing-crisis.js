    ...
    if (selectedChartValue == "sa") {
        ...
        dotChart.enter().append("circle")
            ...
            .on("mouseover", function (d) {
                ...
                div.html("<div style='background-color:black;border-style: solid; border-width:thin; border-color:gray;'>"
                    + "<strong><span style='color:white;text-transform:capitalize'>"
                    + formatDate(d.YEAR) + ": " + d.USA + "</span></strong></div>")
...
//Function called by the 'onclick' event on the data circles.
//Updates the innerHTML DOM in the table to give details on FIFA event. 
function showEdition(d) {
    ...
    var goals = d.GOALS;
    var avgGoals = d.AVERAGE_GOALS;
    var avgAttendance = d.AVERAGE_ATTENDANCE;

    document.getElementById("statTitle").innerHTML = edition;
    document.getElementById("statTeams").innerHTML = teams;
    document.getElementById("statWinner").innerHTML = winner;
    document.getElementById("statGoals").innerHTML = goals;
    document.getElementById("statAverageGoals").innerHTML = avgGoals;
    document.getElementById("statMatches").innerHTML = matches;
    document.getElementById("statAttendance").innerHTML = avgAttendance;
}
